...
var GrovePi = require('./node-grovepi/index.js').GrovePi;
...
//Register Event Based Analog / Digital Sensor (like Button)
 ...
 // Analog Output
 GrovePiBoard.prototype.analogOutput = function(pin, value) {
	if (value >= 0 || value <= 255) {
	   value = Math.round(value);
	   this.board.writeBytes(this.commands.aWrite.concat([pin, value, this.commands.unused]));	 
	} else {
	   console.error('AnalogOutput-wrong input' + state);
	}
 };
